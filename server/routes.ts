  ...
  try {
    ...
    const orderData = {
      ...
      rideOption: {
        ...
        km: body.pricing?.km,
        owner: ownerName,
        ownerNumeroTahiti: (vehicleRow as any).prestataireNumeroTahiti || null,
        loueurVehicleId: vehicleRow.id,
    ...
    try {
      ...
      for (const row of rows) {
        ...
        result.push({
          ...
          modelImageUrl: row.modelImageUrl || null,
          ownerName,
          ownerNumeroTahiti: row.prestataireNumeroTahiti || null,
    ...
    try {
      ...
      const normalized = vehicles.map((v) => {
        ...
        return {
          ...
          maxRentalDays: Number(v.maxRentalDays) || 90,
